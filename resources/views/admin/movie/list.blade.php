    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                <a href="{{route('cms.cinema.form.get',['id'=>0])}}">
            ...
            <div class="card-box table-responsive">
                ...
                <table id="datatable-responsive"
                    ...
                    <tr>
                        ...
                        <td>Siêu nhân Gao</td>
                        <td>
                            <img width="100px" src="https://files.betacorp.vn/files/media/images/2018/09/19/khdc-final-400x633-093154-190918-75.jpg" class="img-rounded img-thumbnail img-responsive">
                        </td>
                        <td>09/18/2019</td>
                        <td>115 phút</td>
                        <td>
                            <input type="checkbox" data-plugin="switchery" data-color="#81c868"/>
                        </td>
                        <td>
