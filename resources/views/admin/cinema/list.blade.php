            ...
            <div class="form-group">
                <a href="{{route('cms.cinema.form.get',['id'=>0])}}">
                    <button class="ladda-button btn btn-default waves-effect waves-light" data-style="expand-right">
                        <span class="btn-label"><i class="fa fa-plus"></i></span>Thêm rạp chiếu
                    </button>
                </a>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box table-responsive">
                <h4 class="m-t-0 header-title"><b>Danh sách rạp chiếu</b></h4>
                <table id="datatable-responsive"
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{route('cms.cinema.form.get',[$detail->id])}}"
