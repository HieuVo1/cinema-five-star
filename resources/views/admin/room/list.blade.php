    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                <a href="{{route('cms.room.form.get',['id'=>0])}}">
                    <button class="ladda-button btn btn-default waves-effect waves-light" data-style="expand-right">
                        <span class="btn-label"><i class="fa fa-plus"></i></span>Thêm phòng chiếu
                    </button>
                </a>
            </div>
        </div>
            ...
            <div class="card-box table-responsive">
                ...
                <table id="datatable-responsive"
                    ...
                    <tr>
                        ...
                        <th>Rạp chiếu</th>
                        <th>Phòng chiếu</th>
                        <th>Mẫu phòng chiếu</th>
                        <th>Hành động</th>
                    </tr>
                    </thead>

                    <tbody>
                    @foreach($rooms as $i => $detail)
                    <tr>
                        <td>{{++$i}}</td>
                        <td>{{$detail->cinema->name}}</td>
                        <td>{{$detail->name}}</td>
                        <td>Mẫu {{$detail->view->id}}</td>
                        <td>

                            <a href="{{route("cms.room.form.get",[$detail->id])}}"
