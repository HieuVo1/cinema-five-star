                ...
                <section class="form-elegant">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body mx-4">
                            ...
                            <form action="{{route('index.reset.post')}}" method="post">
                                {{csrf_field()}}
                                <!--Body-->
                                <div class="md-form">
                                    <input type="password" id="Form-email1" name="newPassword" class="form-control">
                                    <label for="Form-email1">New password</label>
                                </div>

                                <div class="md-form pb-3">
                                    <input type="password" id="Form-pass1" name="confirmPassword" class="form-control">
                                    <label for="Form-pass1">Cofirm password</label>
                                </div>
